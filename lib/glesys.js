...
import { BlockStorage } from './endpoints/blockstorage.js';
import { ColocationRack } from './endpoints/colocationrack.js';
...
import { FileStorage as Filestorage } from './endpoints/filestorage.js';
...
import { RemoteHands } from './endpoints/remotehands.js';
import { Server } from './endpoints/server.js';
import { ServerDisk } from './endpoints/serverdisk.js';
import { Shipment } from './endpoints/shipment.js';
import { SshKey as Sshkey } from './endpoints/sshkey.js';
import { User } from './endpoints/user.js';
import { Vpn } from './endpoints/vpn.js';
import { Request } from './request.js';

export class GleSYSAPI {
    constructor(options = {}) {
    ...
    get blockStorage() {
        return new BlockStorage(this.request);
    }

    get colocationRack() {
        return new ColocationRack(this.request);
    }
    ...
    get remoteHands() {
        return new RemoteHands(this.request);
    }
    ...
    get shipment() {
        return new Shipment(this.request);
    }
