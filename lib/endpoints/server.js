...
class Server extends Endpoint {
    ...
    // https://github.com/glesys/API/wiki/API-Documentation#servercreatemanualbackup
    createManualBackup(data) {
        return this.request.post('/server/createmanualbackup', data);
    }

    // https://github.com/glesys/API/wiki/API-Documentation#serverdeletemanualbackup
    ...
    // https://github.com/GleSYS/API/wiki/API-Documentation#serverestimatedbackupcost
    ...
    // https://github.com/glesys/API/wiki/API-Documentation#serverreset
    reset(data) {
