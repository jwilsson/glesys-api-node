...
export class ObjectStorage extends Endpoint {
    ...
    // https://github.com/GleSYS/API-docs/wiki/API-Documentation#objectstoragecosts
    costs(data) {
        return this.request.post('/objectstorage/costs', data);
    }
